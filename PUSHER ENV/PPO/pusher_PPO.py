...
class Pusher_Mass_UniformDistribution(MujocoEnv, utils.EzPickle):
    ...
    def __init__(
        ...
        plane_geom_name: str = "table",
        **kwargs,
    ):
        # Ottieni la cartella dove si trova questo script (PPO/)
        current_dir = os.path.dirname(os.path.abspath(__file__))
    
    # Risali di un livello (esce da PPO/ e va nella root del progetto)
        parent_dir = os.path.dirname(current_dir)
    
    # Costruisci il path assoluto partendo dalla root
        full_xml_path = os.path.abspath(os.path.join(parent_dir, xml_file))
